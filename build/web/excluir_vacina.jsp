    ...
    <body>
                    ...
                    <div class="col-md-12 col-lg-4">
                        <nav aria-label="breadcrumb" class="breadcrumb-box d-flex justify-content-lg-end">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item color-b" aria-current="page"> Exclus�o de Vacinas </li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="container" id="to-breadcrumb">
            <div class="jumbotron-alert text-center">
                ...
                <p class="lead">Ao continuar com essa opera��o, voc� estar� apagando todos os dados da vacina <strong>${vacina.nome}</strong> permanentemente!</p>
                <hr class="my-4">
