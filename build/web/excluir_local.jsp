    ...
    <body>
                    ...
                    <div class="col-md-12 col-lg-4">
                        <nav aria-label="breadcrumb" class="breadcrumb-box d-flex justify-content-lg-end">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item color-b" aria-current="page"> Exclus�o de Locais </li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="container" id="to-breadcrumb">
            <div class="jumbotron-alert text-center">
                ...
                <p class="lead">Ao continuar com essa opera��o, voc� estar� apagando os dados do local <strong>${local.nome}</strong> permanentemente!</p>
                <hr class="my-4">
                <p>Voc� tem certeza que deseja prosseguir?!</p>
                <a class="btn btn-secondary btn-lg btn-reset" href="/ProjetoIntegrador/ValidarLocal?acao=listaLocais" role="button">Voltar</a>
                <a class="btn btn-danger btn-lg btn-reset" href="/ProjetoIntegrador/ValidarLocal?acao=excluirLocal&idlocal=${local.idlocal}&idendereco=${local.idendereco}" role="button">Sim</a>
            </div>  
        </div>
