            ...
            <form class="formulario" action="ValidarRegistro" method="post">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-2">
                        ...
                        <label class="radio-inline p-l-15">
                            <input type="radio" name="optionReforco" value="N�o"> N�o
                        </label>
                    </div>
                    <div class="form-group col-md-2">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <div class="wrap-input">
                            <input class="inputdados"  type="text" name="txtLabs" id="laboratorio" placeholder="Digite o laborat�rio" minlenght="4" maxlength="30" required>
