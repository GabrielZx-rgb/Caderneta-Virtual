    ...
    <body>
                    ...
                    <div class="col-md-12 col-lg-4">
                        <nav aria-label="breadcrumb" class="breadcrumb-box d-flex justify-content-lg-end">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item color-b" aria-current="page"> Edi��o de Registros de Vacinas </li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="container" id="to-breadcrumb">
            <form class="formulario" action="ValidarRegistro" method="post">
                <h2 class="text-center" style="padding-bottom: 3%;">Edi��o de Registros de Vacinas</h2>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <fieldset disabled>
                            <label for="input">Nome da Pessoa</label>
                            <div class="wrap-input">
                                <input class="inputdados" type="text" name="txtNome" id="nome" value="${usuario.nome}" placeholder="Nome do usu�rio">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-2">
                        <label for="input">N�mero da Dose</label>
                        <div class="wrap-input">
                    ...
                    <div class="form-group col-md-3">
                        <label for="input">Data de Lan�amento</label>
                        <div class="wrap-input">
                ...
                <div class="form-row">
                    <div class="form-group col-md-5">
                        <label for="input">Laborat�rio</label>
                        <div class="wrap-input">
                            <input class="inputdados"  type="text" name="txtLabs" id="laboratorio" placeholder="Digite o laborat�rio" minlenght="4" maxlength="30" value="${registro.laboratorio}">
                            <span class="focus-inputdados"></span><span class="symbol-inputdados"><i class="fa fa-flask" aria-hidden="true"></i></span>
                        </div>
                    </div>
                    <div class="form-group col-md-5">
                        <label for="input">Local da Vacina��o</label>
                        <div class="wrap-input">
