...
<html>
    ...
    <body>
        ...
        <jsp:useBean id="acesso" scope="request" class="br.com.multivix.bean.AcessoBean"/>
        <div class="container" id="introducao">
            <form class="formulario" action="ValidarForm" method="post">
                <h2 class="text-center" style="padding-bottom: 3%;">Formul�rio de Cadastro</h2>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="wrap-input">
                            <input type="text" name="txtMae" class="inputdados" id="nome_mae" placeholder="Digite o nome completo da sua m�e" required>
