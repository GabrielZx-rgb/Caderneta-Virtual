    ...
    <body>
                    ...
                    <div class="col-md-12 col-lg-4">
                        <nav aria-label="breadcrumb" class="breadcrumb-box d-flex justify-content-lg-end">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item color-b" aria-current="page"> Cadastro de Hist�rico </li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="container" id="to-breadcrumb">
            <form class="formulario" action="ValidarHistorico" method="post">
                <h2 class="text-center" style="padding-bottom: 3%;">Lan�amento de Hist�rico</h2>
                <div class="form-row">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                        <label for="input">Per�metro Cef�lico</label>
                        <div class="wrap-input">
